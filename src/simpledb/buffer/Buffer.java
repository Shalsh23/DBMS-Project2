...
//Added by Ashwin
import static simpledb.server.Startup.reference_counter_initialized;
...
public class Buffer {
   ...
   private int reference_counter=simpledb.server.Startup.reference_counter_initialized;		//For now, hard coding it to 5
   
   private Block newBlk = null;
   private String newFileName = "newFile.txt";
   ...
   {	reference_counter=simpledb.server.Startup.reference_counter_initialized;
   }
   ...
   //saves the contents of the buffer into the block
   public Block saveBlock(){
	   newBlk = contents.append(newFileName);
	   return newBlk;
   }
   
   //saves the contents of block into buffer
